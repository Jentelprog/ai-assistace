...
def resp(text):
    if text != "Sorry, I could not understand the audio.":
        if "my screen" in text:
            ...
            if confirm == "OK":
                prompt=f"you will pretend that you are my girlfriend and assistance don't munchin it unless i ask you about it you love me to death. this is the prompt : {text}"
